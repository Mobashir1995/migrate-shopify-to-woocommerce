...
class SWM_Shopify_Product_Cat
{
	...
	public function get_all_shopify_custom_collection(){
		...
		$result_per_request = get_option('wb_swm_cats_per_request') ? get_option('wb_swm_cats_per_request') : SWM_DEFAULT_CAT_PER_REQUEST;
		...
		$import_records = get_option('swm_import_custom_collection_records', $import_records_options);
		...
		update_option('swm_import_custom_collection_records', $swm_import_custom_collection_records );

		$response['swm_import_custom_collection_records'] = get_option('swm_import_custom_collection_records', $import_records_options);
